...
public class ClickButtonNext implements View.OnClickListener {
    @Override
    public void onClick(View v) {

    }
//    private ContentQuestionActivity contentQuestionActivity;
//    ClickButtonNext(ContentQuestionActivity contentQuestionActivity) {
//        this.contentQuestionActivity = contentQuestionActivity;
//    }
//
